    ...
    fields: [
      {
        ...
        options: [
          { label: 'JoyAI-Code-1.5 — 主力代码模型（推荐）', value: 'JoyAI-Code-1.5' },
          { label: 'Claude-Opus-5 — Anthropic Opus 5', value: 'Claude-Opus-5' },
          { label: 'Claude-Opus-4.8 — Anthropic Opus 4.8', value: 'Claude-Opus-4.8' },
          { label: 'GLM-5.3 — 智谱 GLM 5.3', value: 'GLM-5.3' },
          { label: 'GLM-5.2-jcloud', value: 'GLM-5.2-jcloud' },
          { label: 'Kimi-K3 — Moonshot Kimi K3', value: 'Kimi-K3' },
          { label: 'Kimi-K3-jcloud', value: 'Kimi-K3-jcloud' },
          { label: 'DeepSeek-V4-Pro', value: 'DeepSeek-V4-Pro' },
          { label: 'MiniMax-M3', value: 'MiniMax-M3' },
          { label: 'GPT-6 Astra — OpenAI GPT 6', value: 'GPT-6 Astra' },
