...
export default function UsageNotice() {
  return <aside aria-label="使用与信息安全声明" style={{padding:16,overflowWrap:'anywhere'}}>
    ...
    <details><summary style={{cursor:'pointer',fontSize:12}}>使用声明与责任限制</summary>
      <Typography.Paragraph type="secondary" style={{fontSize:12,marginTop:8}}>{usageStatement}</Typography.Paragraph>
    </details>
  </aside>;
}
