...
var modelCapabilities = []ModelCapabilityRow{
	...
	{"GLM-5.2-jcloud", "GLM-5.2-jcloud", "chat", false, true, false, false, 64000, 200000, 928784, "2026-09-11：码字召回成功（92.9万 token，命中缓存69.7万）；非完整长上下文基准"},
	{"Kimi-K3", "Kimi-K3", "chat", true, true, false, false, 64000, 200000, 990117, "2026-09-10：码字召回成功；图片请求接受不等于视觉准确率已验证"},
	{"Kimi-K3-jcloud", "Kimi-K3-jcloud", "chat", true, true, false, false, 64000, 200000, 928874, "2026-09-11：码字召回成功（92.9万 token）；上游目录标注 vision，视觉准确率未单独验证"},
	...
	{"GPT-6 Astra", "GPT-6 Astra", "responses", true, true, false, false, 64000, 200000, 920273, "2026-09-11：码字召回成功（92.0万 token）；92.9万起报错，接近上游约 1M 限制；目录标注 vision 未单独验证"},
	...
	{"Claude-Opus-5", "Claude-Opus-5-hq", "anthropic", true, false, false, false, 64000, 200000, 994760, "2026-09-11：码字召回成功（99.5万 token，两次复测）；100万 token 起报错，与上游 1M 限制一致；个别请求 usage 上报异常（input_tokens=2）"},
